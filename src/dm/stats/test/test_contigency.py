# This code was copied and adapted from scipy 0.10dev (http://github.com/scipy)
...
from dm.stats.contingency import margins, expected_freq, chi2_contingency


class TestContigency(unittest.TestCase):
    ...
    def test_chi2_contingency_trival(self):
